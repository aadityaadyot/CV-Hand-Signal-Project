...
Original file is located at
    https://colab.research.google.com/drive/1v0Uyyy56Eo8w4m1BcgZx0fFkt8IP3rCD
...
# %%time
# %cd /content/yolov5/
# !python train.py --img 545 --batch 16 --epochs 500 --data '../data.yaml' --cfg ./models/custom_yolov5s.yaml --weights 'yolov5s.pt' --name yolov5s_results  --cache
...
# %cd /content/yolov5/
!python detect.py --weights runs/train/yolov5s_results/weights/best.pt --img 545 --conf 0.5 --source ../test/images
